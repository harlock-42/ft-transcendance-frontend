...
export const ChannelBox = ({curRoom, setCurRoom, setMessages, setDisplayDm, channel}: Props) => {
    ...
    return (
        ...
        >
            {channel.imagePath && <Image src={process.env.NEXT_PUBLIC_BACKEND_ENDPOINT + '/social/img' + channel.imagePath} alt={channel.name} width="10px" height="10px" layout="responsive" objectFit="cover"/>
